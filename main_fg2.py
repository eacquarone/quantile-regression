...
# ub80_p_bis = b80_bis + 100*Kalpha_list[0]*np.array(res_to_plot_list[0][1].iloc[:,0])
# ub80_m_bis = b80_bis - 100*Kalpha_list[0]*np.array(res_to_plot_list[0][1].iloc[:,0])

# b90_bis = np.array(res_to_plot_list[1][0].iloc[:,0]) - np.float(res_to_plot_list[1][0].iloc[10,1])
# ub90_p_bis = b90_bis + 100*Kalpha_list[1]*np.array(res_to_plot_list[1][1].iloc[:,0])
# ub90_m_bis = b90_bis - 100*Kalpha_list[1]*np.array(res_to_plot_list[1][1].iloc[:,0])

# b00_bis = np.array(res_to_plot_list[2][0].iloc[:,0]) - np.float(res_to_plot_list[2][0].iloc[10,1])
# ub00_p_bis = b00_bis + 100*Kalpha_list[2]*np.array(res_to_plot_list[2][1].iloc[:,0])
# ub00_m_bis = b00_bis - 100*Kalpha_list[2]*np.array(res_to_plot_list[2][1].iloc[:,0])

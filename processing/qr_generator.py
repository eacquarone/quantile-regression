...
class QRGenerator(object):
    ...
    def process(self):
        ...
        for tau in self.QUANTILES_LIST:
            census80qr["delta_q" + str(tau)] = census80qr["qrlogwk_q" +
                                                          str(tau)] - census80qr["cqlogwk_q" + str(tau)]
            census80qr["epsilon_q" + str(tau)] = census80qr["logwk"] - \
                census80qr["cqlogwk_q" + str(tau)]
        ...
        for tau in self.QUANTILES_LIST:
            census80g['weighted_cqlogwk_q' +
                      str(tau)] = census80g['cqlogwk_q' + str(tau)] * census80g['preduc']
